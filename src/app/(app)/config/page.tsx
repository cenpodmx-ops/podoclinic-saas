...
function SucursalesTab() {
  ...
  const [nf, setNf] = useState({ name: '', slug: '', timezone: 'America/Mexico_City', address: '', phone: '', email: '', openingTime: '09:00', closingTime: '18:00', primaryColor: '#0d9488', secondaryColor: '#0f766e', ownerName: '', ownerEmail: '', ownerPassword: '' })
